...
(function() {
  angular.module('rui.alm.services', ['rui.alm.services.slm', 'rui.alm.services.wsapi', 'rui.alm.services.lookback']);
...
(function() {
  angular.module('rui.analytics.beacon.aggregator', []).factory('RallyMetrics', function($window) {
    ...
    this.$get = function(RallyMetrics) {
      var aggregator;
...
(function() {
  angular.module('rui.analytics.beacon.angulartics', ['angulartics', 'rui.analytics.beacon.aggregator']).config(function($analyticsProvider) {
    return angulartics.waitForVendorApi('rallyBeacon', 500, function(rallyBeacon) {
      $analyticsProvider.registerSetUsername(function(userId) {
        return _.defaults(rallyBeacon.superTraits, {
          userId: userId
        });
      });
  ...
  }).run(function($window, rallyBeacon) {
...
(function() {
  angular.module('rui.analytics.beacon.http', ['rui.analytics.beacon.aggregator']).config(function($provide) {
...
(function() {
  angular.module('rui.analytics.beacon', ['rui.analytics.beacon.angulartics', 'rui.analytics.beacon.http', 'rui.analytics.beacon.aggregator', 'rui.analytics.beacon.zone']);
...
(function() {
  ...
  angular.module('rui.analytics.beacon.zone', ['rui.analytics.beacon.aggregator']).run(function($rootScope, $window, $log, rallyBeacon) {
...
(function() {
  ...
  }).config(function($compileProvider, ruiFlairDirectiveDefinition) {
    var name, _i, _len, _ref, _results;
    _ref = ['ruiFlaire', 'ruiFlair'];
    _results = [];
...
(function() {
  angular.module('rui.flair', ['rui.flair.services', 'rui.flair.directives']);
...
(function() {
  ...
  module = angular.module('rui.flair.services.flair', ['rui.flair.services.flair', 'rui.util.lodash']);

  module.factory('$ruiFlaire', function($ruiFlair) {
    return $ruiFlair;
  });
  ...
  module.service('$ruiFlair', RuiFlair = (function() {
    ...
    */
    ...
    RuiFlair.prototype.open = function(options) {
      var flairInstance, flairOpenDeferred, flairResultDeferred, scope, _ref,
        _this = this;
    ...
    RuiFlair.prototype._createInstance = function(scope) {
      var flairInstance, flairOpenDeferred, flairResultDeferred,
        _this = this;
      ...
      return [flairOpenDeferred, flairResultDeferred, flairInstance];
    };
...
(function() {
  ...
  rui = angular.module('rui', ['rui.sortable', 'rui.highcharts', 'rui.dropdown', 'rui.tabs', 'rui.util', 'rui.scroll', 'rui.forms', 'rui.tree', 'rui.alm', 'rui.flair']);
