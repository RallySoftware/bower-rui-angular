(function() {
  ...
  */
  ...
  angular.module('rui.forms.input.number.directives.number', ['rui.forms.input.number.controllers.number', 'rui.forms.input.number.services.number']).directive('ruiInputNumber', function(InputNumberService) {
    return {
      restrict: 'EA',
