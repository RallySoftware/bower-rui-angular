...
(function () {
  ...
  angular.module('rui.alm.projectPicker.controllers.projectPicker', ['rui.alm.projectPicker.factories.treeSearch']).controller('RuiAlmProjectPickerCtrl', RuiAlmProjectPickerCtrl = function () {
    ...
    RuiAlmProjectPickerCtrl.prototype.selectNode = function (node) {
      var bubbleSelection, _this = this;
    ...
    RuiAlmProjectPickerCtrl.prototype.search = function (term) {
      ...
      if (term) {
        ...
        return this.currentSearch.search({ children: this.$scope.$ruiAlmProjectPicker.workspaces }, 1000)['finally'](function (state) {
...
(function () {
  var RuiAlmProjectPickerNodeCtrl, __bind = function (fn, me) {
      return function () {
        return fn.apply(me, arguments);
      };
    };
...
(function () {
  angular.module('rui.alm.projectPicker.controllers', [
    'rui.alm.projectPicker.controllers.projectPicker',
    'rui.alm.projectPicker.controllers.projectPickerNode'
  ]);
}.call(this));
(function () {
...
(function () {
  angular.module('rui.alm.projectPicker.directives.projectPickerNode', [
    'rui.alm.projectPicker.controllers.projectPickerNode',
    'rui.tree'
  ]).directive('ruiAlmProjectPickerNodeCtrl', function () {
    return {
      restrict: 'A',
      scope: true,
      require: [
        'ruiAlmProjectPickerNodeCtrl',
        'ruiTreeNodeCtrl'
      ],
...
(function () {
  angular.module('rui.alm.projectPicker.factories', [
    'rui.alm.projectPicker.factories.treeBuilder',
    'rui.alm.projectPicker.factories.treeSearch'
  ]);
}.call(this));
/**
 * @ngdoc service
...
(function () {
  ...
  angular.module('rui.alm.projectPicker.factories.treeSearch', [
    'rui.util.filters.regExpEscape',
    'rui.util.lodash',
    'ngSanitize'
  ]).factory('ruiAlmProjectPickerTreeSearchFactory', [
    '$injector',
    function ($injector) {
...
(function () {
  ...
  angular.module('rui.tree.controllers.node', [
    ...
    function RuiTreeNodeCtrl($scope, ruiTreeTimeoutThrottle, $timeout, $compile, $log, RuiTreeNodePlaceHolderWarning) {
      ...
      this.$scope.$ruiTreeNode = { hasChildren: false };
...
(function () {
  angular.module('rui.tree.directives.tree', [
    ...
    'rui.util.template',
    'rui.tree.controllers.tree'
  ]).directive('ruiTreeCtrl', function () {
    return {
      restrict: 'EA',
      require: ['ruiTreeCtrl'],
      scope: true,
